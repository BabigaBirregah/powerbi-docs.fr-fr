...
![Espace de travail](media/embed-multi-tenancy/multi-tenant-saas-workspace.png)
...
![Sécurité au niveau des lignes](media/embed-multi-tenancy/multi-tenant-saas-rls.png)
