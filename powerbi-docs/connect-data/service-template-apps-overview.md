...
:::row:::
    :::column:::
        [![Application web Microsoft Project](./media/service-template-apps-overview/project-web.png)](https://app.powerbi.com/groups/me/getapps/services/pbi_msprojectonline.pbi-microsoftprojectwebapp)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        [![Application web Microsoft Forms Pro – Satisfaction des clients](./media/service-template-apps-overview/forms-pro.png)](https://app.powerbi.com/groups/me/getapps/services/msfp.formsprocustomersatisfaction)
    :::column-end:::
:::row-end:::

 > [!NOTE] 
 > Les applications de la Place de marché ne sont pas disponibles pour les instances de cloud US Government. Pour plus d’informations, consultez [Power BI pour les clients du gouvernement des États-Unis](../admin/service-govus-overview.md).
...
- Si vous êtes éditeur de logiciels indépendant et que vous distribuez votre application par le biais de votre service web, envisagez d’automatiser la configuration des paramètres au cours de l’installation pour faciliter la tâche de vos clients et augmenter la probabilité d’une installation réussie. Pour plus d’informations, consultez [Configuration automatisée d’une installation d’application modèle](../developer/template-apps/template-apps-auto-install.md).
