---
title: Découvrez quels packages R sont pris en charge
...
Les packages R pris en charge pour le **service Power BI** se trouvent dans la section suivante intitulée **Packages pris en charge**. Si vous souhaitez demander la prise en charge d’un package R introuvable dans cette liste, envoyez votre demande sur le site [Power BI Ideas](https://ideas.powerbi.com).
...
|R2OpenBUGS|2.1-21|https://cran.r-project.org/web/packages/R2WinBUGS/index.html|
...
|RevoIOQ|8.0.10|N/A|
|RevoMods|11.0.0|N/A|
|RevoUtils|10.0.9|N/A|
|RevoUtilsMath|10.0.1|N/A|
