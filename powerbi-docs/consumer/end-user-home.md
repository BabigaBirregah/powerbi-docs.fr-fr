---
title: Rechercher du contenu sur l’Accueil du service Power BI
...
![Capture d’écran du volet de navigation du service Power BI, avec Accueil sélectionné](media/end-user-home/power-bi-select-home.png)
...
![Capture d’écran du canevas d’accueil du service Power BI.](media/end-user-home/power-bi-canvas.png)
...
- Sur la gauche se trouve un volet de navigation. Sélectionnez ![Icône Hamburger pour développer le volet de navigation](media/end-user-home/power-bi-expand.png) pour développer le volet de navigation. Dans le volet de navigation, le contenu est organisé de façon légèrement différente, selon les options suivantes : Favoris, Récents, Applications et Partagés avec moi. Vous pouvez voir des listes de contenu et en sélectionner une pour l’ouvrir.
...
![menu volant Favoris](./media/end-user-home/power-bi-home-favorites.png)
...
![Contenu recommandé, promu par l’administrateur](./media/end-user-home/power-bi-home-featured.png)

### <a name="recents-shared-with-me-and-my-apps"></a>Récents, Partagés avec moi et Mes applications
...
![Vue de la liste d’accueil avec l’onglet Récents sélectionné](./media/end-user-home/power-bi-recents.png)
...
![Un seul espace de travail, Mon espace de travail](./media/end-user-home/power-bi-one-workspace.png)

Si vous sélectionnez cet espace de travail, vous le trouverez vide.

![Mon espace de travail vide](./media/end-user-home/power-bi-empty-workspace.png)
...
![Capture d’écran de la section Espaces de travail de l’Accueil](./media/end-user-home/power-bi-workspaces-more.png)
...
![Espace de travail Jardinage sélectionné](./media/end-user-home/power-bi-search-workspace.png)
...
![Contenu recommandé listé dans l’écran d’accueil](./media/end-user-home/power-bi-recommended.png)
 
### <a name="getting-started-learning-resources"></a>Ressources d’apprentissage pour bien démarrer
...
- Pour voir le contenu le plus récent de chaque conteneur, sélectionnez le menu volant ( **>** ).
    ...
    ![Vidéo montrant l’utilisation du volet de navigation pour le conteneur Récents](media/end-user-home/recents2.gif)
...
## <a name="search-all-of-your-content"></a>Rechercher tout votre contenu
...
![Capture d’écran de l’utilisation du champ de recherche dans Récents](media/end-user-home/power-bi-search-field.png)
